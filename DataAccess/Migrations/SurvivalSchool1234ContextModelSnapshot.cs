...
{
    [DbContext(typeof(SurvivalSchool1234Context))]
    partial class SurvivalSchool1234ContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.ForumPost", b =>
                {
                    ...
                    b.HasIndex(new[] { "ThreadId" }, "IX_ForumPosts_ThreadID");
            ...
            modelBuilder.Entity("Domain.Models.ForumThread", b =>
                {
                    ...
                    b.HasIndex(new[] { "CreatedBy" }, "IX_ForumThreads_CreatedBy");
            ...
            modelBuilder.Entity("Domain.Models.Lecture", b =>
                {
                    ...
                    b.HasIndex(new[] { "CategoryId" }, "IX_Lectures_CategoryID");

                    b.HasIndex(new[] { "CreatedBy" }, "IX_Lectures_CreatedBy");

                    b.ToTable("Lectures");
                });

            modelBuilder.Entity("Domain.Models.LectureComment", b =>
                {
            ...
            modelBuilder.Entity("Domain.Models.Test", b =>
                {
                    ...
                    b.HasIndex(new[] { "CreatedBy" }, "IX_Tests_CreatedBy");
            ...
            modelBuilder.Entity("Domain.Models.TestQuestion", b =>
                {
                    ...
                    b.HasIndex(new[] { "TestId" }, "IX_TestQuestions_TestID");
            ...
            modelBuilder.Entity("Domain.Models.UserTestResult", b =>
                {
                    ...
                    b.HasIndex(new[] { "TestId" }, "IX_UserTestResults_TestID");

                    b.HasIndex(new[] { "UserId" }, "IX_UserTestResults_UserID");
            ...
            modelBuilder.Entity("Domain.Models.Video", b =>
                {
                    ...
                    b.HasIndex(new[] { "CategoryId" }, "IX_Videos_CategoryID");

                    b.HasIndex(new[] { "CreatedBy" }, "IX_Videos_CreatedBy");

                    b.ToTable("Videos");
                });

            modelBuilder.Entity("Domain.Models.VideoComment", b =>
                {
                    b.Property<int>("CommentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Models.LectureComment", b =>
                {
                    ...
                    b.HasOne("Domain.Models.LectureComment", "ParentComment")
            ...
            modelBuilder.Entity("Domain.Models.VideoComment", b =>
                {
                    b.HasOne("Domain.Models.VideoComment", "ParentComment")
                        .WithMany("InverseParentComment")
                        .HasForeignKey("ParentCommentId")
